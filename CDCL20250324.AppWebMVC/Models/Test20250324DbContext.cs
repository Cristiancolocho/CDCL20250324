...
public partial class Test20250324DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Brands__3214EC076DF66FD5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC07A31D3D5E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07100D6086");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105348DD59D6C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Warehous__3214EC0756F469D2");
